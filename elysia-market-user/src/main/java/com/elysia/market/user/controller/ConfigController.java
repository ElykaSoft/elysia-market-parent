...
import com.elysia.market.user.handler.BlockExceptionHandler;
import com.elysia.market.user.handler.FallbackExceptionHandler;
...
public class ConfigController {
    ...
    @SentinelResource(value = "sentinel.info",
            ...
            exceptionsToIgnore = {NullPointerException.class})
    public Result<String> getOrderInfo2(String orderId) throws ServiceFailException {
